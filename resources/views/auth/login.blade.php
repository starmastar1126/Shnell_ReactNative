      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-6 relative align-self-center">
            <form method="POST" action="{{ route('login') }}" class="bg-white rounded pb_form_v1">
           @csrf
              <h2 class="mb-4 mt-0 text-center">Log in</h2>
              
              <div class="form-group">
                <input type="text" class="form-control pb_height-50 reverse" placeholder="Email"  name="email" id="email" required autofocus>
                   @if ($errors->has('email'))
              ...
              <div class="form-group">
                <input type="submit" class="btn btn-primary btn-lg btn-block pb_btn-pill  btn-shadow-blue" value="Log in">
